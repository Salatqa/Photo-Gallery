...
<path style="opacity:0.2;fill:#826165;enable-background:new    ;" d="M83.808,417.502c-40.279-40.296-62.481-93.856-62.481-150.846
	...
	c40.295,40.296,93.855,62.481,150.837,62.481c3.578,0,7.141-0.094,10.671-0.266C171.024,477.139,121.589,455.266,83.808,417.502z"/>
				...
				<li>
                    <a href="index.php">Galeria prac</a>
                    <ul>
	...
	<section>
		...
		<h2>Panel użytkownika</h2> </br>
        </br>

		<?php require_once '../controllers.php';
			if($_SESSION['logged']===false || empty($_SESSION['logged']) )
			{?>
		...
		<p class="text">Chcesz się wylogować? Możesz to zrobić poniżej. Mam nadzieję, że Twoja wizyta była udana. Do zobaczenia następnym razem!</p>
